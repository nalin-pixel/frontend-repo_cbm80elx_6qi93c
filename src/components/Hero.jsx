...
export default function Hero() {
  ...
  const subOpacity = useTransform(scrollYProgress, [0, 0.2], [1, 0.85])

  return (
    <section className="relative pt-28 md:pt-32 pb-20 md:pb-28 overflow-hidden">
      <div className="absolute inset-0">
        <Spline scene="https://prod.spline.design/VyGeZv58yuk8j7Yy/scene.splinecode" style={{ width: '100%', height: '100%' }} />
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(800px_400px_at_50%_0%,rgba(59,130,246,0.22),transparent)]" />
        <motion.div style={{ opacity: glowOpacity }} className="pointer-events-none absolute inset-0 bg-gradient-to-b from-slate-950/10 via-slate-950/50 to-slate-950" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-10">
        <div className="lg:col-span-8 flex flex-col items-start">
          ...
          <motion.h1
            ...
            style={{ y: titleY }}
            className="mt-5 text-[10vw] leading-[0.95] md:text-7xl font-semibold tracking-tight text-white"
          >
            From <KineticWords words={["sparks","signals","briefs","hunches"]} />
          ...
          <motion.p
            ...
            className="mt-5 text-slate-300 text-lg md:text-xl max-w-2xl"
          >
            Capture, cluster, score and plan with an orchestration layer that keeps momentum. Minimal UI, maximal clarity.
          </motion.p>
